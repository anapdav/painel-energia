...
NOTAS_ABA = {
    ...
    "Shale EUA": (
        ...
        "meses, não anos — é ele quem responde ao preço. O <b>DPR</b> (Drilling "
        "Productivity Report, da EIA) acompanhava as sete bacias: o <b>Permian</b> (Texas "
        "e Novo México) domina o óleo, enquanto <b>Appalachia</b> e <b>Haynesville</b> "
        "são essencialmente gás. A <b>produção do poço novo por sonda</b> é a medida de "
        "eficiência — e o segredo da resiliência do setor: ganhos contínuos de "
        "produtividade permitem produzir mais com menos sondas. <b>DUCs</b> (drilled but "
        "uncompleted) são os poços já perfurados que aguardam fraturamento; quando se "
        "completa mais do que se perfura, esse estoque é consumido — produção hoje, ao "
        "custo da atividade futura. Licenças de perfuração (<b>permits</b>) não são dado "
        "da EIA, e sim das agências estaduais; o indicador de atividade aqui era o número "
        "de poços perfurados. <b>Atenção:</b> a EIA descontinuou o DPR e o relatório de "
        "DUCs (últimas edições em jun/2024 e abr/2024). Os painéis históricos ficam "
        "preservados como referência estrutural; o acompanhamento corrente do shale passa "
        "pela produção mensal por estado (dois primeiros painéis), pelos rigs semanais da "
